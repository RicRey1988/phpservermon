...
Version 4.2.1-hs — latest signed Hosting Supremo release
...
Download the signed ``4.2.1-hs`` package and review its release notes at
https://github.com/RicRey1988/phpservermon/releases/tag/v4.2.1-hs. The Release
...
``4.2.1-hs`` is published through that signed channel and can be installed from
