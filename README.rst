...
Version 4.3.5-hs — latest signed Hosting Supremo release
...
Download the signed ``4.3.5-hs`` package and review its release notes at
https://github.com/RicRey1988/phpservermon-Redesigned-by-hostingsupremo/releases/tag/v4.3.5-hs. The Release
...
``4.3.5-hs`` is published through that signed channel and can be installed from
