...
Version 4.3.3-hs — latest signed Hosting Supremo release
...
Download the signed ``4.3.3-hs`` package and review its release notes at
https://github.com/RicRey1988/phpservermon/releases/tag/v4.3.3-hs. The Release
...
``4.3.3-hs`` is published through that signed channel and can be installed from
